...
import ArtifactFlow from '../../components/writing/ArtifactFlow.astro';
import ContextPipeline from '../../components/writing/ContextPipeline.astro';
import DelegationSpectrum from '../../components/writing/DelegationSpectrum.astro';
import FederationPair from '../../components/writing/FederationPair.astro';
import HarnessReadiness from '../../components/writing/HarnessReadiness.astro';
import ReadinessScan from '../../components/writing/ReadinessScan.astro';
import RelatedWork from '../../components/writing/RelatedWork.astro';
import RepositoryContract from '../../components/writing/RepositoryContract.astro';
...
<ArtifactFlow
  phases={[
    {
      label: 'Capture',
      steps: ['breakthrough away from the laptop', 'rough voice note'],
    },
    {
      label: 'Delegate',
      steps: ['remote feasibility research', 'repository-owned GitHub issue'],
    },
    {
      label: 'Decide + deliver',
      steps: ['human refinement and judgment', 'epic specification', 'implementation'],
    },
  ]}
/>
...
<ContextPipeline
  ...
  runtime="ephemeral cloud-agent sandbox"
  output="inspectable artifact and accountable review"
/>
...
<DelegationSpectrum
  modes={[
    { title: 'Capture', description: 'preserve the idea as a context-rich issue.' },
    { title: 'Explore', description: 'research feasibility and expose assumptions.' },
    { title: 'Propose', description: 'prepare an inspectable change without publishing it.' },
    { title: 'Execute', description: 'implement within explicit boundaries and return evidence.' },
  ]}
/>
...
<FederationPair
  capabilities={[
    { title: 'Reachability', description: 'a controlled network path to the protected resource.' },
    {
      title: 'Authentication',
      description: 'a short-lived, least-privilege credential for this run and this resource.',
    },
  ]}
/>
...
<figure class="article-figure">
  <img
    src="/images/writing/the-harness-should-not-live-on-your-laptop/federated-identity.webp"
    alt="An ephemeral sandbox sends a short-lived amber identity across an attestation bridge to a protected registry."
    width="1672"
    height="941"
    loading="lazy"
    decoding="async"
...
<HarnessReadiness
  ...
  groups={[
    ...
    {
      label: 'Governed',
      items: ['Define identity, permissions, approval, and audit boundaries.'],
    },
    {
      label: 'Proven',
      items: [
