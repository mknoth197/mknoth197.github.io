...
- A **DNS subdomain-hijacking defense**: audited **2,678 DNS forwarders across 908 hosted zones** and built automated verification and cleanup with the on-prem DNS and security teams, eliminating takeover risk.
