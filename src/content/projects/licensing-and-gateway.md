---
title: "License Management & Global Gateway"
summary: "On the License Management team — a high-volume customer-facing web application accounting for ~10% of John Deere's annual revenue — I engineered a secure data ingestion pipeline during a hackathon to prove the value of making license data available to internal teams while preserving data isolation and access controls. That work directly contributed to the formation of a new Data Engineering team. Earlier, on the Global Gateway API platform, I architected the platform's inaugural external API with role-based authorization and comprehensive audit logging, enabling dealers to safely access sales leads data."
period: "2019 – 2023"
