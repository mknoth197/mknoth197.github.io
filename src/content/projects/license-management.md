...
- A **secure data-ingestion pipeline**, prototyped during a hackathon, that demonstrated license data could be shared internally while preserving data isolation and access controls.
